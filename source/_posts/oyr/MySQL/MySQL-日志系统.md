...
![慢查询日志图片](https://kubpang.github.io/sourceFile/MySQL/1624261484667.jpg)
...
![日志查询分析器帮助信息图片](https://kubpang.github.io/sourceFile/MySQL/日志查询分析器使用.jpg)
...
修改配置文件后，重启服务配置生效  
查看 bin log 日志文件  
![bin log 日志文件](https://kubpang.github.io/sourceFile/MySQL/1624350274231.jpg)
